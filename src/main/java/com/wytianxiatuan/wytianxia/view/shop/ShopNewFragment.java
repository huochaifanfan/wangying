...
public class ShopNewFragment extends BaseFragment implements IMainView,OnRefreshListener,OnRefreshLoadmoreListener,MainType6Adapter.OnDetailClickListener {
    ...
    private void getData(int flag){
        ...
        cancelable = presenter.merchantShops(shopId,"1",content,page+"",flag);
    }
    @Override
