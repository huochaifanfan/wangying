...
import com.wytianxiatuan.wytianxia.overrideview.banner.listener.OnBannerClickListener;
import com.wytianxiatuan.wytianxia.overrideview.banner.listener.OnBannerListener;
import com.wytianxiatuan.wytianxia.overrideview.banner.loader.ImageLoaderInterface;
import com.wytianxiatuan.wytianxia.overrideview.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = 0;
    private int mIndicatorUnselectedResId = 0;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        pageMargin = typedArray.getDimensionPixelSize(R.styleable.Banner_page_margin , 0);
        ...
        mLayoutResId = typedArray.getResourceId(R.styleable.Banner_banner_layout , R.layout.banner);
        typedArray.recycle();
    }
